            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border:0; background-color: #ffffff; padding: 50px 54px;">
                ...
                @endforeach
                    ...
                    <tr>
                        ...
                        <td colspan = "5" align="center" style="padding: 8px;border-bottom: black 1px solid;border-left: black 1px solid;">Total Associated</td>
                    ...
                    <tr>
                        <td colspan = "1" align="center" style="padding: 8px;border-bottom: black 1px solid;border-left: black 1px solid;"></td>
                        <td colspan = "5" align="center" style="padding: 8px;border-bottom: black 1px solid;border-left: black 1px solid;">No of resumes not <br/> achieved</td>
                ...
                @if(isset($user_details->lead_report) && $user_details->lead_report == 'Yes')
                    ...
                    @foreach($leads_weekly as $key=>$value)
                        <tr>
                            ...
                            <td align="center" style="border-top: black 1px solid;padding: 8px; <?php if ($total_cnt==$j): ?>border-bottom: black 1px solid;<?php endif ?>  border-left: black 1px solid;">{{ $value['location']}}</td>

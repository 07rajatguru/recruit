...
<body style="margin: 0; padding-top: 30px; background-color: #f5f5f5;">
    @foreach($mail as $key => $value)
        @if($value['module'] == 'Training Material')
        ...
        @elseif($value['module'] == 'Today\'s Training Material')
            <table border="0" cellpadding="0" cellspacing="0" width="600" style="font-family:Helvetica,Arial,sans-serif; border-collapse: collapse; color: #444444;" align="center">
                                ...
                                @foreach($trainings as $k => $v)
                                    <tr style="background-color:white;height: 30px;">
                                        ...
                                        <td align="center" width="90">
                                            <a style="border: black; background-color: #9c5cac;color: white;padding: 3px 15px 3px 15px; border-radius: 18px;font-size: 15px;width: 59%;" class="btn btn-primary" formtarget="_blank" href="{{getenv('APP_URL').'/training/'.$v['t_id'].'/show'}}">Show</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif

		...
		<table style="width: 40%;">
			<tr>
				<td colspane="10" style="width: 7;">
					<img src="{{ public_path().'/images/Adler-Header.jpg' }}" height="120%" width="120%" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="4" style="border: 5px solid #000000;vertical-align:top;width: 24;" height="60">Address: {{ $invoice_data['shipping_address'] }}
				</td>
			</tr>
			<tr>

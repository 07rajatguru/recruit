...
<html>
	<body>
		<table style="width: 40%;">
			...
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Company PAN No  :  AAMCA2137K  |  GST No: 24AAMCA2137K1ZP  |  Service Category  :  Manpower Services</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">MSME Registration No. : GJ01D0136980</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;"><u>Subject To Ahmedabad Jurisdiction</u></td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Please make cheque payable to: Adler Talent Solutions Pvt. Ltd.
				</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Bank Name : ICICI Bank Limited</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Branch Name : SG Road branch</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Account Number : 029505002727</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">Type of Account : Current Account</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10" style="font-size: 10.5;">IFSC Code : ICIC0000295</td>
			</tr>
			<tr>
				<td></td>
				<td colspan="10"></td>
			...
			<tr>
				...
				<td style="width: 13;" colspan="9"></td>
			</tr>
			<tr>
				<td></td>

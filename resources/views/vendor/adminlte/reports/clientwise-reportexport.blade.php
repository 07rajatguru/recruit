<table class="table table-striped table-bordered nowrap" cellspacing="0" width="100%" id="clientwise-report" style="border: 2 solid #000000;">
	<thead>
		<tr style="background-color: #7598d9">
			...
			<th style="border: 2px solid #000000;text-align: center;width: 20;">Candidate Name</th>
			<th style="border: 2px solid #000000;text-align: center;width: 15;">Client Owner</th>
			<th style="border: 2px solid #000000;text-align: center;width: 22;">Position / Dept</th>
			<th style="border: 2px solid #000000;text-align: center;width: 25;">Salary offered <br/> (fixed)</th>
			<th style="border: 2px solid #000000;text-align: center;width: 10;">Billing</th>
			<th style="border: 2px solid #000000;text-align: center;width: 15;">GST <br/> @ 18%</th>
			...
			<th style="border: 2px solid #000000;text-align: center;width: 45;">Efforts With</th>
			<th style="border: 2px solid #000000;text-align: center;width: 25;">Contact Person</th>
			<th style="border: 2px solid #000000;text-align: center;width: 8;">Status</th>
		</tr>
	</thead>
	...
	@else
		<tbody>
			<tr>
				<td colspan="12" style="text-align: center;border: 2px solid black;" class="button">
				No Data Found.</td>
			</tr>
		</tbody>
	@endif

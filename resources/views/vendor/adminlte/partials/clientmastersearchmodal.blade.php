    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 client_owner_cls" style="display: none;">
                <div class="">
                    <div class="form-group"><br/>
                        <strong>Select Client Owner : </strong>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 client_cat_cls" style="display: none;">
                <div class="">
                    <div class="form-group"><br/>
                        <strong>Select Client Category : </strong>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 client_status_cls" style="display: none;">
                <div class="">
                    <div class="form-group"><br/>
                        <strong>Select Client Status : </strong>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 client_industry_cls" style="display: none;">
                <div class="">
                    <div class="form-group"><br/>
                        <strong>Select Client Industry : </strong>
                        {!! Form::select('client_industry', $industry,null, array('id'=>'client_industry','class' => 'form-control','tabindex' => '1')) !!}
                    </div>
                </div>
            </div>

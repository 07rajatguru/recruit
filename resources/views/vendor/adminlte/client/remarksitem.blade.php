        ...
        <div class="user-option">
            <ul>
                <div class="auth-links">
                    <li>
                        <a href="#" title="Add Comment" data-toggle="modal" onclick="showcommentbox({{$per_post->id }})"><i class="fa fa-plus" aria-hidden="true"></i></a>
                    </li>

                    @permission(('display-client'))
                        <li>
                            <a href="#" title="Edit Post" data-toggle="modal" data-target="#update-review-{{$per_post->id }}"><i class="fa fa-pencil" aria-hidden="true"></i>
                            </a>
                        </li>
                    @else
                        @if((isset(Auth::user()->id) && $per_post->user->id == \Auth::user()->id))
                            <li>
                                <a href="#" title="Edit Post" data-toggle="modal" data-target="#update-review-{{$per_post->id }}"><i class="fa fa-pencil" aria-hidden="true">
                                </i></a>
                            </li>
                        @endif
                    @endpermission

        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 min_ctc_cls" style="display: none;">
                    <div class="">
                        <div class="form-group"><br/>
                            <strong>Enter Min CTC : </strong>
                            {!! Form::text('min_ctc', null, array('id'=>'min_ctc','placeholder' => 'Min CTC','class' => 'form-control', 'tabindex' => '1')) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 max_ctc_cls" style="display: none;">
                    <div class="">
                        <div class="form-group"><br/>
                            <strong>Enter Max CTC : </strong>
                            {!! Form::text('max_ctc', null, array('id'=>'max_ctc','placeholder' => 'Max CTC','class' => 'form-control', 'tabindex' => '1')) !!}
                        </div>
                    </div>
                </div>

            ...
            <ul>
                <div class="auth-links">
                    ...
                    @if((isset(Auth::user()->id) && $per_post->user->id == \Auth::user()->id))
                        <li>
                            <a href="#" title="Edit Remarks" data-toggle="modal" data-target="#update-review-{{$per_post->id }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        </li>
                    @endpermission

                    @permission(('display-work-planning'))
                        <li>
                            <a href="javascript:void(0);" title="Dlete Remarks" onclick="deletePost({{$per_post->id }})"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </li>
                    @endpermission
                </div>
            </ul>
...
<div class="modal fade" id="update-review-{{$per_post->id }}">
    <div class="modal-dialog ui-block window-popup edit-widget update-review">
        ...
        <div class="ui-block-title"><h4>Update Remarks</h4></div>
        ...
        <div class="ui-block-content">
            ...
            {!!Form::textarea('content',$per_post->content, array('placeholder' =>'Add Remarks','id' => 'update-review-textarea-'.$per_post->id,'class' => 'form-control update-review-textarea','rows' => 5, 'required' => true)) !!}

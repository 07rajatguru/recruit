...
class TrainingController extends Controller
{
    public function index() {
        ...
        return view('adminlte::training.index',compact('training','isSuperAdmin','user_id','count','isManager'));
    }
    ...
    public function show($id){
        ...
        ->where('training_visible_users.training_id',$id)
        ->get();
        ...
        return view('adminlte::training.show',compact('trainingdetails','training_material','user_id','isSuperAdmin','isManager'));
    }

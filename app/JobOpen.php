...
class JobOpen extends Model
{
    ...
    public static function getAllJobsByAM($all=0,$user_id,$limit=0,$offset=0,$search=0,$order=NULL,$type='desc',$current_year=NULL,$next_year=NULL,$client_heirarchy=0) {
        ...
        $job_open_query = $job_open_query->whereNotIn('job_openings.priority',$job_status);
        $job_open_query = $job_open_query->where('client_basicinfo.second_line_am','=',$user_id);
        $job_open_query = $job_open_query->groupBy('job_openings.id');

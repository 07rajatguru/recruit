...
class WorkPlanning extends Model
{
    ...
    public static function getWorkPlanningByAddedDateAndUserID($date,$user_id) {
        ...
        $query = $query->where('work_planning.added_by','=',$user_id);
        $query = $query->select('work_planning.id','work_planning.attendance','work_planning.status','work_planning.total_actual_time','work_planning.added_date','work_planning.loggedin_time','work_planning.attendance');
    ...
    // Function use for Daily Work Planning Summary Script
    public static function getWorkPlanningsByDateAndUserId($user_id,$date) {

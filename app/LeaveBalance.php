...
class LeaveBalance extends Model
{
    ...
    public static function getAllUserWiseLeave(){
        ...
        foreach ($res as $key => $value) {
            ...
            $leave_data[$i]['seek_leave_total'] = $value->seek_leave_total;
            $leave_data[$i]['seek_leave_taken'] = $value->seek_leave_taken;
            $leave_data[$i]['seek_leave_remaining'] = $value->seek_leave_remaining;
            $i++;
        }
